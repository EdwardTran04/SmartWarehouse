...
============================================================ */
const notes = [
  { t: "Task mới được giao", m: "TSK-2095 · Putaway 8 HU tại Khu G", time: "1 phút", tone: "info" as const, icon: ListChecks },
  { t: "Sắp quá hạn", m: "TSK-9925 KCS còn 8 phút", time: "8 phút", tone: "warn" as const, icon: Clock },
  { t: "Quá hạn", m: "TSK-9930 Putaway đã quá 1h12", time: "1 giờ", tone: "err" as const, icon: AlertTriangle },
  { t: "Xe quá ETA", m: "Xe 29C-184.55 quá ETA 12 phút", time: "12 phút", tone: "err" as const, icon: Truck },
  { t: "KCS có kết quả", m: "Lô L-2026-005 đạt 100%", time: "30 phút", tone: "done" as const, icon: CheckCircle2 },
  { t: "API SAP lỗi", m: "Gửi T-AGR INB-2026-00118 timeout 504", time: "45 phút", tone: "err" as const, icon: Send },
  { t: "Chứng từ bị từ chối ký", m: "GR-2026/05/13-101 từ chối VOffice", time: "2 giờ", tone: "err" as const, icon: XCircle },
  { t: "Vị trí putaway sai", m: "HU-...-04 cất sai khu G→H", time: "3 giờ", tone: "warn" as const, icon: MapPin },
  { t: "Task bị reassign", m: "TSK-9915 chuyển sang Trần Nam", time: "Hôm qua", tone: "info" as const, icon: RefreshCw },
];
