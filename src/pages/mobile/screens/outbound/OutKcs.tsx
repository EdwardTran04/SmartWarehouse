...
/* =============================================================
   OUTBOUND SCREEN: X6. OutKcs - Kiểm hàng xuất
   Design giống inbound Check screen
================================================================ */
type LineItem = {
  id: string;
  sku: string;
...
const MOCK_ITEMS: LineItem[] = [
  { id: "L1", sku: "SP-A001", name: "Galaxy A15 128GB", rfid: "RFID-88121-A1", productType: "Điện thoại", productTypeVi: "Điện thoại", hasSerial: true, serial: "SN-2026-0012345", docQty: 1, realQty: 1 },
  { id: "L2", sku: "SP-A002", name: "Galaxy A25 256GB", rfid: "RFID-88122-A1", productType: "Điện thoại", productTypeVi: "Điện thoại", hasSerial: true, serial: "SN-2026-0012346", docQty: 1, realQty: 1 },
  { id: "L3", sku: "SP-A003", name: "Tai nghe Buds Pro", rfid: "RFID-88123-B2", productType: "Phụ kiện", productTypeVi: "Phụ kiện", hasSerial: true, serial: "SN-2026-0012347", docQty: 1, realQty: 1 },
  { id: "L4", sku: "SP-A004", name: "Cáp sạc USB-C 1m", rfid: "RFID-88124-C3", productType: "Vật tư", productTypeVi: "Vật tư", hasSerial: false, docQty: 50, realQty: 50 },
  { id: "L5", sku: "SP-A005", name: "Ống lót máy", rfid: "RFID-88125-D4", productType: "Vật tư", productTypeVi: "Vật tư", hasSerial: false, docQty: 120, realQty: 120 },
  { id: "L6", sku: "SP-A006", name: "Keo dán chuyên dụng", rfid: "RFID-88126-E5", productType: "Vật tư", productTypeVi: "Vật tư", hasSerial: false, docQty: 35, realQty: 35 },
];
...
export function ScreenOutKcs({ back }: { back: () => void }) {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-slate-50 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      <TopBar
        brand
        title="Kiểm hàng xuất"
        sub="OUT-2026-00452 · 6 dòng"
        onBack={back}
        right={
          <button
      ...
      {showConfirmModal && (
        <Modal
          title={confirmAction === "accept" ? "Xác nhận kiểm hàng" : "Xác nhận từ chối"}
          onClose={() => {
            setShowConfirmModal(false);
            setConfirmAction(null);
            setRejectReason("");
          ...
          primary={{
            label: confirmAction === "accept" ? "Xác nhận kiểm hàng" : "Xác nhận từ chối",
