...
/* =============================================================
   OUTBOUND SCREEN: X4. OutPack - Đóng gói xuất
   Design identical to inbound Pack screen
================================================================ */
type PackItem = {
  sku: string;
  name: string;
...
const PACK_ITEMS: PackItem[] = [
  { sku: "SP-A001", name: "Galaxy A15 128GB", serial: "SN-2026-0012345", rfid: "RFID-88121-A1", boxType: "Carton 50", boxTypeList: ["Carton 25", "Carton 50", "Carton 100", "Pallet"] },
  { sku: "SP-A002", name: "Galaxy A25 256GB", serial: "SN-2026-0012346", rfid: "RFID-88122-A1", boxType: "Carton 50", boxTypeList: ["Carton 25", "Carton 50", "Carton 100", "Pallet"] },
  { sku: "SP-A003", name: "Tai nghe Buds Pro", serial: "SN-2026-0012347", rfid: "RFID-88123-B2", boxType: "Carton 25", boxTypeList: ["Carton 25", "Carton 50", "Carton 100", "Pallet"] },
  { sku: "SP-A004", name: "Cáp sạc USB-C 1m", serial: "", rfid: "RFID-88124-C3", boxType: "Carton 100", boxTypeList: ["Carton 25", "Carton 50", "Carton 100", "Pallet"] },
];
    ...
    <div className="flex-1 flex flex-col overflow-hidden bg-slate-50 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-3 pb-4">
        <div className="grid grid-cols-2 gap-2">
          ...
          <Btn size="sm" icon={CheckCircle2} onClick={back}>
            Hoàn thành
          </Btn>
        </div>
      </div>
