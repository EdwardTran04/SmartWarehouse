...
/* =============================================================
   OUTBOUND SCREEN: X5. OutWaitArea - Đưa hàng ra khu chờ xuất
   Design giống Putaway - chỉ HU, name, Loại thùng, Mã RFID
================================================================ */
type WaitItem = {
  hu: string;
  sku: string;
...
const WAIT_ITEMS: WaitItem[] = [
  { hu: "HU-88121", sku: "SP-A001", name: "Galaxy A15 128GB", boxType: "Carton 50", rfid: "RFID-88121-A1", qty: 40 },
  { hu: "HU-88122", sku: "SP-A002", name: "Galaxy A25 256GB", boxType: "Carton 50", rfid: "RFID-88122-A1", qty: 40 },
  { hu: "HU-88123", sku: "SP-A003", name: "Tai nghe Buds Pro", boxType: "Carton 25", rfid: "RFID-88123-B2", qty: 30 },
  { hu: "HU-88124", sku: "SP-A004", name: "Ốp lưng Clear Cover", boxType: "Carton 100", rfid: "RFID-88124-C3", qty: 25 },
  { hu: "HU-88125", sku: "SP-A005", name: "Cáp sạc USB-C", boxType: "Carton 100", rfid: "RFID-88125-C3", qty: 25 },
];

export function ScreenOutWaitArea({ back }: { back: () => void }) {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-slate-50 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      <TopBar
        brand
        title="Đưa hàng ra khu chờ xuất"
        sub={`OUT-2026-00452 · ${WAIT_ITEMS.length} HU`}
        onBack={back}
        right={
          <button
        ...
        <div className="absolute inset-0 z-50 bg-black/40 flex items-end" onClick={() => setShowPhotoModal(false)}>
          <div className="w-full bg-white rounded-t-2xl p-4 pb-6 space-y-3" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-[13px] text-slate-500 text-center">Vui lòng chụp ảnh hàng hóa tại khu chờ xuất</p>
            </div>
