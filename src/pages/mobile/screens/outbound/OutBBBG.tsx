...
/* =============================================================
   OUTBOUND SCREEN: X7. OutBBBG - Ký Biên bản bàn giao hàng hóa xuất
   Design giống inbound BBBG
================================================================ */
export function ScreenOutBBBG({ back }: { back: () => void }) {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-slate-50">
      <TopBar brand title="Ký Biên bản bàn giao" sub="BBBG-2026/05/18-052" onBack={back} />
          ...
          {showPdfPreview && (
            <div className="mt-3">
              <div className="bg-slate-100 rounded-xl border-2 border-dashed border-slate-300 aspect-[3/4] flex flex-col items-center justify-center text-slate-400">
                ...
                <span className="text-[13px] font-medium">BBBG-2026/05/18-052.pdf</span>
        ...
        <div className="absolute inset-0 z-40 bg-black/40 flex items-end" onClick={() => setShowConfirm(false)}>
          <div className="w-full bg-white rounded-t-3xl p-5 pb-7 space-y-3" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="text-[13px] text-slate-600 space-y-1">
              <p>Bạn xác nhận đã kiểm tra hàng và hoàn tất việc bàn giao cho lô hàng <b>OUT-2026-00452</b>.</p>
            </div>
